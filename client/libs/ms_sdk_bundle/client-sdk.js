(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['lodash', 'q', 'EventEmitter', 'localforage', 'moment', 'tv4', 'CryptoJS', requirejs.s.contexts._.config.paths.$Libs+"/ms_sdk_bundle/underscore-query/underscore-query.amd.min"], function (_, Q, EventEmitter, localforage, moment, tv4, CryptoJS) {
